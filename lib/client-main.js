...
var ClientMain = function () {
   ...
   this.emitter.on(EVENTS.ConnectServer,  (function(_this) {
    ...
    this.emitter.on(EVENTS.ReqQryTopCpuInfoTopic,  (function(_this) {
        return function(reqData) { 
            var data={};
            data.event = EVENTS.ReqQryTopCpuInfoTopic;
            data.reqField = reqData;
            _this.childProcess.send(data);
        };
    })(this));
    ...
    this.emitter.on(EVENTS.ReqQryMonitorOnlineUser,  (function(_this) {
        return function(reqData) { 
            var data={};
            data.event = EVENTS.ReqQryMonitorOnlineUser;
            data.reqField = reqData;
            _this.childProcess.send(data);
        };
    })(this));

    this.emitter.on(EVENTS.ReqQryFrontStatTopic,  (function(_this) {
        return function(reqData) { 
            var data={};
            data.event = EVENTS.ReqQryFrontStatTopic;
            data.reqField = reqData;
            _this.childProcess.send(data);
        };
    })(this));
    ...
    this.emitter.on(EVENTS.ReqQryWarningActiveChange,  (function(_this) {
        return function(reqData) { 
            var data={};
            data.event = EVENTS.ReqQryWarningActiveChange;
            data.reqField = reqData;
            _this.childProcess.send(data);
        };
    })(this));
    ...
    this.emitter.on(EVENTS.ReqQryMonConfigInfo,  (function(_this) {
        return function(reqData) { 
            var data={};
            data.event = EVENTS.ReqQryMonConfigInfo;
            data.reqField = reqData;
            _this.childProcess.send(data);
        };
    })(this));

    this.emitter.on(EVENTS.ReqMonServiceConnect,  (function(_this) {
        return function(reqData) { 
            var data={};
            data.event = EVENTS.ReqMonServiceConnect;
            data.reqField = reqData;
            _this.childProcess.send(data);
        };
    })(this));

    this.emitter.on(EVENTS.ReqQryMonServiceStatus,  (function(_this) {
        return function(reqData) { 
            var data={};
            data.event = EVENTS.ReqQryMonServiceStatus;
            data.reqField = reqData;
            _this.childProcess.send(data);
        };
    })(this));

    this.emitter.on(EVENTS.ReqQryMonProbeTask,  (function(_this) {
        return function(reqData) { 
            var data={};
            data.event = EVENTS.ReqQryMonProbeTask;
            data.reqField = reqData;
            _this.childProcess.send(data);
        };
    })(this));

    this.emitter.on(EVENTS.ReqQryMonObjectAttr,  (function(_this) {
        return function(reqData) { 
            var data={};
            data.event = EVENTS.ReqQryMonObjectAttr;
            data.reqField = reqData;
            _this.childProcess.send(data);
        };
    })(this));

    this.emitter.on(EVENTS.ReqQryMonSyslogEvent,  (function(_this) {
        return function(reqData) { 
            var data={};
            data.event = EVENTS.ReqQryMonSyslogEvent;
            data.reqField = reqData;
            _this.childProcess.send(data);
        };
    })(this));

    this.emitter.on(EVENTS.ReqQryMonFileOffset,  (function(_this) {
        return function(reqData) { 
            var data={};
            data.event = EVENTS.ReqQryMonFileOffset;
            data.reqField = reqData;
            _this.childProcess.send(data);
        };
    })(this));

    this.emitter.on(EVENTS.ReqQryMonFileContent,  (function(_this) {
        return function(reqData) { 
            var data={};
            data.event = EVENTS.ReqQryMonFileContent;
            data.reqField = reqData;
            _this.childProcess.send(data);
        };
    })(this));

    this.emitter.on(EVENTS.ReqQryMonHostCPUAttr,  (function(_this) {
        return function(reqData) { 
            var data={};
            data.event = EVENTS.ReqQryMonHostCPUAttr;
            data.reqField = reqData;
            _this.childProcess.send(data);
        };
    })(this));

    this.emitter.on(EVENTS.ReqQryMonHostMemAttr,  (function(_this) {
        return function(reqData) { 
            var data={};
            data.event = EVENTS.ReqQryMonHostMemAttr;
            data.reqField = reqData;
            _this.childProcess.send(data);
        };
    })(this));

    this.emitter.on(EVENTS.ReqQryMonHostNetworkAttr,  (function(_this) {
        return function(reqData) { 
            var data={};
            data.event = EVENTS.ReqQryMonHostNetworkAttr;
            data.reqField = reqData;
            _this.childProcess.send(data);
        };
    })(this));

    this.emitter.on(EVENTS.ReqQryMonHostStatInfo,  (function(_this) {
        return function(reqData) { 
            var data={};
            data.event = EVENTS.ReqQryMonHostStatInfo;
            data.reqField = reqData;
            _this.childProcess.send(data);
        };
    })(this));

    this.emitter.on(EVENTS.ReqQryMonHostRouterInfo,  (function(_this) {
        return function(reqData) { 
            var data={};
            data.event = EVENTS.ReqQryMonHostRouterInfo;
            data.reqField = reqData;
            _this.childProcess.send(data);
        };
    })(this));

    this.emitter.on(EVENTS.ReqQryMonHostProcessInfo,  (function(_this) {
        return function(reqData) { 
            var data={};
            data.event = EVENTS.ReqQryMonHostProcessInfo;
            data.reqField = reqData;
            _this.childProcess.send(data);
        };
    })(this));

    this.emitter.on(EVENTS.ReqQryMonSPQuery,  (function(_this) {
        return function(reqData) { 
            var data={};
            data.event = EVENTS.ReqQryMonSPQuery;
            data.reqField = reqData;
            _this.childProcess.send(data);
        };
    })(this));

    this.emitter.on(EVENTS.ReqServiceVersion,  (function(_this) {
        return function(reqData) { 
            var data={};
            data.event = EVENTS.ReqServiceVersion;
            data.reqField = reqData;
            _this.childProcess.send(data);
        };
    })(this));

    this.emitter.on(EVENTS.ReqServiceProgram,  (function(_this) {
        return function(reqData) { 
            var data={};
            data.event = EVENTS.ReqServiceProgram;
            data.reqField = reqData;
            _this.childProcess.send(data);
        };
    })(this));

    this.emitter.on(EVENTS.ReqUpdateState,  (function(_this) {
        return function(reqData) { 
            var data={};
            data.event = EVENTS.ReqUpdateState;
            data.reqField = reqData;
            _this.childProcess.send(data);
        };
    })(this));

    this.emitter.on(EVENTS.ReqSubscribe,  (function(_this) {
        return function(reqData) { 
            var data={};
            data.event = EVENTS.ReqSubscribe;
            data.reqField = reqData;
            _this.childProcess.send(data);
        };
    })(this));

    this.emitter.on(EVENTS.ReqCancelSubscribe,  (function(_this) {
        return function(reqData) { 
            var data={};
            data.event = EVENTS.ReqCancelSubscribe;
            data.reqField = reqData;
            _this.childProcess.send(data);
        };
    })(this));

    this.emitter.on(EVENTS.ReqQryMonHostBasicEnv,  (function(_this) {
        return function(reqData) { 
            var data={};
            data.event = EVENTS.ReqQryMonHostBasicEnv;
            data.reqField = reqData;
            _this.childProcess.send(data);
        };
    })(this));

    this.emitter.on(EVENTS.ReqQryMonHostNetworkEnv,  (function(_this) {
        return function(reqData) { 
            var data={};
            data.event = EVENTS.ReqQryMonHostNetworkEnv;
            data.reqField = reqData;
            _this.childProcess.send(data);
        };
    })(this));

    this.emitter.on(EVENTS.ReqQryMonHostFileSysEnv,  (function(_this) {
        return function(reqData) { 
            var data={};
            data.event = EVENTS.ReqQryMonHostFileSysEnv;
            data.reqField = reqData;
            _this.childProcess.send(data);
        };
    })(this));

    this.emitter.on(EVENTS.ReqQryMonHostSwapEnv,  (function(_this) {
        return function(reqData) { 
            var data={};
            data.event = EVENTS.ReqQryMonHostSwapEnv;
            data.reqField = reqData;
            _this.childProcess.send(data);
        };
    })(this));

    this.emitter.on(EVENTS.ReqQryMonitor2ObjectTopic,  (function(_this) {
        return function(reqData) { 
            var data={};
            data.event = EVENTS.ReqQryMonitor2ObjectTopic;
            data.reqField = reqData;
            _this.childProcess.send(data);
        };
    })(this));

    this.emitter.on(EVENTS.ReqQryMonHostCommonEnvTopic,  (function(_this) {
        return function(reqData) { 
            var data={};
            data.event = EVENTS.ReqQryMonHostCommonEnvTopic;
            data.reqField = reqData;
            _this.childProcess.send(data);
        };
    })(this));

    this.emitter.on(EVENTS.ReqQryMonOidHostRationalTopic,  (function(_this) {
        return function(reqData) { 
            var data={};
            data.event = EVENTS.ReqQryMonOidHostRationalTopic;
            data.reqField = reqData;
            _this.childProcess.send(data);
        };
    })(this));

    this.emitter.on(EVENTS.ReqQryMonOidRelationTopic,  (function(_this) {
        return function(reqData) { 
            var data={};
            data.event = EVENTS.ReqQryMonOidRelationTopic;
            data.reqField = reqData;
            _this.childProcess.send(data);
        };
    })(this));
