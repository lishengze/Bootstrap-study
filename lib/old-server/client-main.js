...
var childProcessFileName = 'client-child.js';
// var childProcessFileName = 'test-writeFile.js';

var ClientMain = function () {
   this.emitter       = new EventEmitter;
   this.childFilePath = path.join( __dirname, childProcessFileName);
   ...
   this.emitter.on(EVENTS.ConnectServer,  (function(_this) {
    ...
    this.emitter.on(EVENTS.ReqQryOidRelationTopic,  (function(_this) {
        return function(reqData) {
            console.log ("ReqQryOidRelationTopic!");
            var data={};
    ...
    this.emitter.on(EVENTS.ReqQryNetMonitorAttrScopeTopic,  (function(_this) {
        return function(reqData) {
            console.log ("ReqQryNetMonitorAttrScopeTopic!");
            var data={};
